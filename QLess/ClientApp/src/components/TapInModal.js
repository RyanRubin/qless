...
const TapInModal = ({ setShowModal, cardId, setCardId }) => {
    ...
    const tapIn = async () => {
        ...
        const balance = await window.appFetch(`transportcards/${cardId}/tapin/${transportLineId}/${transportStationId}`, 'POST');
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        <button type="button" className="btn btn-secondary" onClick={tapIn}>Tap In</button>
